...
for type in types:
    ...
    for l in range(len(annos[index][0])):
        ...
        for i in range(len(gts)):
            ...
            if label == 1 and h >= 50 and visibility >= 0.65:
    ...
    print('{} has {} images and {} valid images, {} valid gt and {} ignored gt ({} because too occluded)'.format(
        type, len(annos[index][0]), valid_count, box_count, iggt_count, occluded))
