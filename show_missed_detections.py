...
n_bins = 40
axs[0].hist_trn(vis_reasonable, bins=n_bins)
axs[0].set_title('reasonable')
axs[1].hist_trn(vis_occluded, bins=n_bins)
...
fig, axs = plt.subplots(1, 2, sharey=True, tight_layout=True)
n_bins = 40
axs[0].hist_trn(-np.asarray(vis_reasonable), bins=n_bins, cumulative=True, density=True)
axs[0].set_title('reasonable')
axs[0].grid()
axs[1].hist_trn(-np.asarray(vis_occluded), bins=n_bins, cumulative=True, density=True)
axs[1].set_title('occluded')
axs[1].grid()
...
fig, axs = plt.subplots(1, 2, sharey=True, tight_layout=True)
n_bins = 40
axs[0].hist_trn(height_reasonable, bins=n_bins)
axs[0].set_title('reasonable')
axs[1].hist_trn(height_occluded, bins=n_bins)
axs[1].set_title('occluded')
axs[1].set_title('occluded')
...
fig, axs = plt.subplots(1, 2, sharey=True, tight_layout=True)
n_bins = 40
axs[0].hist_trn(height_reasonable, bins=n_bins, cumulative=True, density=True)
axs[0].set_title('reasonable')
axs[0].grid()
axs[1].hist_trn(height_occluded, bins=n_bins, cumulative=True, density=True)
axs[1].set_title('occluded')
axs[1].grid()
...
n_bins = 20
axs[0].hist_trn(missed_reasonable_visibility, bins=n_bins)
axs[0].set_title('reasonable ({})'.format(len(missed_reasonable_height)))
axs[1].hist_trn(missed_occluded_visibility, bins=n_bins)
...
# We can set the number of bins with the `bins` kwarg
n_bins = 20
axs[0].hist_trn(missed_reasonable_height, bins=n_bins)
axs[0].set_title('reasonable ({})'.format(len(missed_reasonable_height)))
axs[1].hist_trn(missed_occluded_height, bins=n_bins)
axs[1].set_title('occluded ({})'.format(len(missed_occluded_height)))
