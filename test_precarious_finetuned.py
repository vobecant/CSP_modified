...
C = config.Config()
C.offset = True
cache_path = 'data/precarious_dataset/test_annotations'
images_folder = 'data/precarious_dataset/images'
...
if C.offset:
    w_path = 'output/valmodels/precarious/{}/off{}'.format(C.scale, exp_name)
    out_path = 'output/valresults/precarious/{}/off{}_finetuned'.format(C.scale, exp_name)
else:
    w_path = 'output/valmodels/precarious/{}/nooff{}'.format(C.scale, exp_name)
    out_path = 'output/valresults/precarious/{}/nooff{}_finetuned'.format(C.scale, exp_name)
...
for w_ind in range(min_epoch, max_epoch):
    ...
    if os.path.exists(res_file):
        print('{} already exists... Evaluating again...'.format(res_file))
