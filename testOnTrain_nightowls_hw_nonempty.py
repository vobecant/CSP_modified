...
expname = sys.argv[3]
w_path = os.path.join('/home/vobecant/PhD/CSP/output/valmodels/nightowls/hw', expname)
...
C = config.Config()
C.offset = True
cache_path = 'data/cache/nightowls/extendedEmpty_1P_hard'
with open(cache_path, 'rb') as fid:
    val_data = cPickle.load(fid)
num_imgs = len(val_data)
print('num of training samples to test: {}'.format(num_imgs))
