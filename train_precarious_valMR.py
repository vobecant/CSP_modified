...
if C.network == 'resnet50':
    ...
    weight_dir = 'output/valmodels/city_valMR/h/off{}'.format(exp_name)
...
if C.offset:
    out_path = 'output/valmodels/precarious_valMR/{}/off{}'.format(C.scale, exp_name)
else:
    out_path = 'output/valmodels/precarious_valMR/{}/nooff{}'.format(C.scale, exp_name)
