...
if C.offset:
    w_path = 'output/valmodels/precarious_valMR/{}/off{}'.format(C.scale, exp_name)
    out_path = 'output/valresults/precarious_valMR/{}/off{}_finetuned'.format(C.scale, exp_name)
else:
    w_path = 'output/valmodels/precarious_valMR/{}/nooff{}'.format(C.scale, exp_name)
    out_path = 'output/valresults/precarious_valMR/{}/nooff{}_finetuned'.format(C.scale, exp_name)
