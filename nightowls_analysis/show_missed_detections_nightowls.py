...
plt.figure()
plt.hist(missed_occluded_height, bins=bins)
plt.title('Heights of missed occluded test samples ({}).'.format(len(missed_occluded_height)))
plt.tight_layout()
plt.savefig(os.path.join(save_dir_plots, 'test_heights_missed_occluded.jpg'))
plt.close()

plt.figure()
plt.hist(missed_reasonable_height, bins=bins)
plt.title('Heights of missed reasonable test samples ({}).'.format(len(missed_reasonable_height)))
plt.tight_layout()
